...
#Advancement Upgrade
execute as @s[tag=!exi_advu] run function existence_smp:advancement_check/playtime/100
execute as @s[tag=!exi_advu] run function existence_smp:advancement_check/elytra/500
execute as @s[tag=!exi_advu] run function existence_smp:advancement_check/deaths/50
tag @s add exi_advu
