tellraw @a ["",{"selector":"@s"},{"text":" is now displaying ","color":"gray"},{"text":"Elytra distance","color":"dark_purple"}]
...
execute as @a[scores={exi_elytra_km=1..}] run tellraw @s ["",{"text":"You have flown ","color":"gray","italic":true},{"score":{"name":"@s","objective":"exi_elytra_km"},"color":"dark_purple","italic":true},{"text":"km with elytra","color":"gray","italic":true}]
