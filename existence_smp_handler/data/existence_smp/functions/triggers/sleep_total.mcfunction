...
execute as @a[scores={mpp_sleep_adv=1}] run tellraw @s ["",{"text":"You have slept for ","color":"gray","italic":true},{"score":{"name":"@s","objective":"mpp_sleep_adv"},"color":"gold","italic":true},{"text":" night","color":"gray","italic":true}]
execute as @a[scores={mpp_sleep_adv=2..}] run tellraw @s ["",{"text":"You have slept for ","color":"gray","italic":true},{"score":{"name":"@s","objective":"mpp_sleep_adv"},"color":"gold","italic":true},{"text":" nights","color":"gray","italic":true}]
