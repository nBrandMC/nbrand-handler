...
advancement grant @s[name=Seishirou_] only existence_smp:events/events 
advancement grant @s[name=TheMundane] only existence_smp:events/events
advancement grant @s[name=mcpeachpies] only existence_smp:events/events
advancement grant @s[name=Yoglington] only existence_smp:events/events
advancement grant @s[name=iGalaxy] only existence_smp:events/events
advancement grant @s[name=Dr_Little] only existence_smp:events/events
advancement grant @s[name=DuoGetsRekt] only existence_smp:events/events
advancement grant @s[name=INeedHelp__] only existence_smp:events/events
advancement grant @s[name=marcoiscool] only existence_smp:events/events
advancement grant @s[name=Neko_Cub] only existence_smp:events/events
...
advancement grant @s[name=theowlguardian] only existence_smp:events/events
...
advancement grant @s[name=DuoGetsRekt] only existence_smp:events/ancient_city
...
advancement grant @s[name=DuoGetsRekt] only existence_smp:events/nbrand_tragedy
