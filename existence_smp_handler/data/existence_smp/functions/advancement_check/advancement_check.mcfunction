...
tag @s[name=R3dSmoke] add adv_legacy
tag @s[name=Concraft_Plays] add adv_legacy
...
tag @s[name=MC_ZombieSlayer] add adv_legacy
...
tag @s[name=INeedHelp__] add adv_woodland_manion_raid
...
tag @s[name=Savannah1533] add adv_woodland_manion_raid
...
tag @s[name=INeedHelp__] add adv_ender_dragon_fight
...
tag @s[name=Savannah1533] add adv_ender_dragon_fight
...
tag @s[name=INeedHelp__] add adv_end_city_raiding
tag @s[name=Savannah1533] add adv_end_city_raiding
...
tag @s[name=Savannah1533] add adv_secret_santa_2022
