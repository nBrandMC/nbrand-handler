...
#Welcome
tellraw @s [{text:""},{text:"Welcome ",color:"gray"},{selector:"@s"},{text:" to the ",color:"gray"},{text:"nBrand Creative Server!",color:"dark_red"}]
tellraw @s [{text:""},{text:"Visit ",color:"gray"},{text:"existencesmp.com/server ",italic:true,color:"gray",click_event:{action:"open_url",url:"https://existencesmp.com/server"},hover_event:{action:"show_text",value:[{text:"Official Website of the nBrand",italic:true,color:"gray"}]}},{text:"for more info.",color:"gray"}]
