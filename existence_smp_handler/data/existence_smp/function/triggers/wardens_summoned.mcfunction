tellraw @a ["",{"selector":"@s"},{"text":" is now displaying ","color":"gray"},{"text":"Total Wardens Summoned","color":"dark_red"}]
...
execute as @a if score @s exi_warden_count matches 1 run tellraw @s ["",{"text":"You summoned ","color":"gray","italic":true},{"text":"1","color":"dark_red","italic":true},{"text":" Warden","color":"gray","italic":true}]
execute as @a if score @s exi_warden_count matches 2.. run tellraw @s ["",{"text":"You have summoned ","color":"gray","italic":true},{"score":{"name":"@s","objective":"exi_warden_count"},"color":"dark_red","italic":true},{"text":" Wardens","color":"gray","italic":true}]
