tellraw @s[gamemode=survival] [{text:""},{text:"nBrand Creative Server map ",color:"dark_red"},{text:"map.existencesmp.com",italic:true,color:"gray",click_event:{action:"open_url",url:"https://map.existencesmp.com"},hover_event:{action:"show_text",value:[{text:"nBrand Creative Server map",italic:true,color:"gray"}]}}]
