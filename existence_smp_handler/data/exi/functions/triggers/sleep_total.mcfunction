...
tellraw @s[scores={mpp_sleep_adv=1..}] ["",{"text":"You have been slept for ","color":"gray","italic":true},{"score":{"name":"@s","objective":"mpp_afk_adv"},"color":"gold","italic":true},{"text":" days","color":"gray","italic":true}]
